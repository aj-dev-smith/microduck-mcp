...
MOODS = {
    "neutral": Mood(),
    "excited": Mood(asetrate=55600, tempo=0.95,
                    vibrato_depth=0.13, tremolo_depth=0.20,
                    grain_gain=0.90, syllable_share=2 / 3,
                    mouth_release_s=0.070),
    "sad": Mood(asetrate=52800, tempo=0.80,
                vibrato_depth=0.06, tremolo_depth=0.10,
                grain_tag="coo", grain_gain=0.60, syllable_share=1 / 3,
                mouth_release_s=0.140),
    "alarmed": Mood(tempo=0.96, tremolo_depth=0.28,
                    grain_tag="alarm", grain_gain=0.85, syllable_share=2 / 3,
                    mouth_release_s=0.070),
    "smug": Mood(asetrate=53500, tempo=0.84,
                 vibrato_depth=0.15, tremolo_depth=0.14,
